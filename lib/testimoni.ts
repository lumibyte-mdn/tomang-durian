...
const testimoni = [
    ...
    },
    {
        ...
        avatar: img1,
        textId: '“ The landing page is visually stunning and has significantly boosted our event bookings. The exclusive design, clean layout, and smooth user experience are outstanding. Since launch, our inquiries have grown rapidly! (IDN)”.',
        textEn: '"Lorem ipsum dolor sit amet."',
